...
{
    public partial class CountryStateDistSA : System.Web.UI.Page
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                count = db.getDb_Value("select count(CountryId) from tblAdmissionDetails where CountryId='" + ViewState["CountryId"].ToString() + "'");
        ...
        protected void btnDeleteS_Click(object sender, EventArgs e)
        {
            try
            {
                count = db.getDb_Value("select count(StateId) from tblAdmissionDetails where  StateId='" + ViewState["StateId"].ToString() + "'  ");
        ...
        protected void btnDeleteD_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                count = db.getDb_Value("select count(DistrictId) from tblAdmissionDetails where DistrictId='" + ViewState["DistrictId"] + "'");
