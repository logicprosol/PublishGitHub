<%@ Page Title="AddStaff" Language="C#" MasterPageFile="~/Forms/SuperAdmin/SuperAdmin.Master" AutoEventWireup="true"
    CodeBehind="AddStaff.aspx.cs" Inherits="CMS.Forms.SuperAdmin.AddStaff" %>
                ...
                <asp:Panel ID="Panel_PersonalInfo" runat="server" Visible="true" Style="height: 890px;
                    ...
                    <table border="0" width="90%" align="center" cellspacing="2px">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtFirstName"  onkeypress="return onlyAlphabets(event,this); "  runat="server" ValidationGroup="PersonalInfo"></asp:TextBox>
                            </td>
                            <td>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="rfvFirstName" runat="server" ForeColor="red" ErrorMessage="Please Enter First Name !!!"
                                    ControlToValidate="txtFirstName"  ValidationExpression="[aA-zZ]"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtMiddleName" runat="server" onkeypress="return onlyAlphabets(event,this); " ValidationGroup="PersonalInfo"></asp:TextBox>
                            </td>
                            <td>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtLastName" runat="server" onkeypress="return onlyAlphabets(event,this); " ValidationGroup="PersonalInfo"></asp:TextBox>
                            </td>
                            <td>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtMotherName" onkeypress="return onlyAlphabets(event,this); " runat="server" ValidationGroup="PersonalInfo"></asp:TextBox>
                            </td>
                            <td>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CalendarExtender ID="txt_BirthDate_CalendarExtender" runat="server" TargetControlID="txt_BirthDate"
                                    OnClientDateSelectionChanged="CheckDate" Format="MM/dd /yyyy" DaysModeTitleFormat="MM/dd/yyyy" TodaysDateFormat="MM/dd/yyyy">
                        ...
                        <td>
                            ...
                            <td>
                                  <asp:TextBox ID="txtHandicapPercentage" runat="server" ValidationGroup="PersonalInfo" MaxLength="3"></asp:TextBox>
                                <%--   <asp:RequiredFieldValidator ID="rfvHandicapPercentage" runat="server" ForeColor="red" ErrorMessage="Please Enter Handicap Percentage !!!"
                                  ...
                                  <asp:RegularExpressionValidator ID="rveHandicapPer" runat="server" ErrorMessage="Enter valid Percentage"
                                     ...
                                     ValidationExpression="(^(100(?:\.0{1,2})?))|(?!^0*$)(?!^0*\.0*$)^\d{1,2}(\.\d{1,2})?$">
                ...
                <asp:Panel ID="Panel_ContactGeneralInfo" runat="server" Visible="false">
                    <div id="Div_ContactGeneralInfo" Style="height: 890px; width: 900px; border: double #0C7BFA"
                        ...
                        <table border="0" width="90%" align="center" cellspacing="2px">
                            <tr>
                                <td>
                                    <asp:Label ID="lblPresentAddress" runat="server" Text="Address : " CssClass="formlable"></asp:Label>
                        ...
                        <table border="0" width="90%" align="center" cellspacing="2px">
                            <tr>
                                <td style="width: 10%">
                                    <asp:Label ID="lblPermanentAddress" runat="server" Text="Address : " CssClass="formlable"></asp:Label>
                        ...
                        <table border="0" width="90%" align="center" cellspacing="2px">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtPhoneNumber" runat="server" Width="200px" MaxLength="12" ValidationGroup="GeneralDetails"></asp:TextBox>
                                </td>
                                <td>
                         ...
                         <%--   <tr>
                                ...
                                <td>
                                    <asp:Label ID="Label35" runat="server" Text="College Name : "></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="DrpCollegeName" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DrpCollegeName_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                                <td>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label39" runat="server" Text="Designation : "></asp:Label>
                                </td>
                                <td>
