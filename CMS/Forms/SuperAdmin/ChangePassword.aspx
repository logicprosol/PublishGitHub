<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/SuperAdmin/SuperAdmin.Master"
    AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="CMS.Forms.SuperAdmin.ChangePassword" %>
            ...
            <div class="MainBody">
                <table border="0" width="80%" align="center" cellspacing="2px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtOldPassword" runat="server" ValidationGroup="ValidatePassword"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNewPassword" runat="server" ValidationGroup="ValidatePassword"
                                TextMode="Password"></asp:TextBox>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtConfirmPassword" runat="server" ValidationGroup="ValidatePassword"
                                TextMode="Password"></asp:TextBox>
                        </td>
                        <td>
