<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/SuperAdmin/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="DepartmentDesignationSA.aspx.cs" Inherits="CMS.Forms.SuperAdmin.DepartmentDesignationSA" %>
                                ...
                                <ContentTemplate>
                                    <table border="0" width="80%" align="center" cellspacing="2px">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlOrganization" runat="server"  ValidationGroup="General" Width="180px" AutoPostBack="True" OnSelectedIndexChanged="ddlOrganization_SelectedIndexChanged">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel_Designation" runat="server" align="center" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <table border="0" width="80%" align="center" cellspacing="2px">
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblFirstName4" runat="server" CssClass="formlable" Font-Bold="True" Text="Select Organization"></asp:Label>
                                                <br />
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="ddlOrganization1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlOrganization1_SelectedIndexChanged" ValidationGroup="General" Width="180px">
