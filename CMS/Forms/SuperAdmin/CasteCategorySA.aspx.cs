...
{
    public partial class CasteCategorySA : System.Web.UI.Page
    {
        //Objects
        #region[Objects]
        ...
        private void GrdCasteCategoryBind()
        {
            try
            {
                ...
                objEWA.OrgId = Convert.ToInt32(ddlOrganization.SelectedValue); //Convert.ToInt32(Session["OrgId"]);
        ...
        private void Action(string strAction)
        {
            try
            {
                ...
                objEWA.OrgId = Convert.ToInt32(ddlOrganization.SelectedValue); //Convert.ToInt32(orgId.ToString());
                objEWA.IsActive = "True";

                int flag = objBL.CasteCategoryAction_BL(objEWA);
