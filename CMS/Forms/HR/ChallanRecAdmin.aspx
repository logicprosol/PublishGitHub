<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Forms/HR/HR.Master" CodeBehind="ChallanRecAdmin.aspx.cs" Inherits="CMS.Forms.HR.ChallanRecAdmin" %>
           ...
           <Triggers>
            ...
            <div class="col-md-3" style="max-height: 660px;overflow: auto;" >
                ...
                <asp:GridView ID="grid" runat="server" BorderStyle="None" CssClass="" Width="98%" CellPadding="4" Style="margin-left: -19px;" 
                    AutoGenerateColumns="false" AutoPostBack="false" DataKeyNames="studentId"   OnRowCommand="grid_RowCommand"  OnRowDataBound="grid_RowDataBound" 
     ageIndexChanging="grid_PageIndexChanging" >
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Student Approve" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Button ID="btnapprove" runat="server" CommandName="Approve" Text="Approve" CommandArgument="<%# Container.DataItemIndex %>" Enabled="true"  />
