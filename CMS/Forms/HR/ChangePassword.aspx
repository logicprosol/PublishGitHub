<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/HR/HR.Master"  AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs"
    Inherits="CMS.Forms.HR.ChangePassword" %>
                ...
                <table border="0" width="80%" align="center" cellspacing="2px">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            ...
                            <asp:Button ID="btnCancel" runat="server" Text="Cancel" class="btn btn-primary" CausesValidation="false" OnClick="btnCancel_Click" />
                        </td>
                        <td>
                        </td>
                        <td>
