<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/HR/HR.Master" AutoEventWireup="true" CodeBehind="messageSend.aspx.cs" Inherits="CMS.Forms.HR.messageSend" %>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:GridView ID="GrdStudent" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                            ...
                                            AllowPaging="True" BackColor="White" BorderWidth="1px" PageSize="4">
                                            <Columns>
                            ...
                            <tr>
                                <td colspan="4">
                                    <asp:GridView ID="GrdEmployee" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        Width="100%" BorderColor="#3366CC" BorderStyle="None" AllowPaging="True" 
                                        BackColor="White" BorderWidth="1px" >
                                        <Columns>
                                            <asp:TemplateField HeaderText="Select" ItemStyle-HorizontalAlign="Center">
                                                <HeaderTemplate>
