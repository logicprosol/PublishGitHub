<%@ Page Language="C#" MasterPageFile="~/Forms/Faculty/Faculty.Master" AutoEventWireup="true"
    CodeBehind="~/Forms/Faculty/SendMessage.aspx.cs" Inherits="CMS.Forms.Faculty.SendMessage" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel_SendMessage" runat="server" align="center" UpdateMode="Conditional">
                ...
                <!-- Select Sender Type  -->
                   ...
                   <!-- Student Panel -->
                            ...
                            <table style="width: 100%" align="center">
                                ...
                                <tr>
                                    <td colspan="4">
                                        ...
                                        <asp:GridView ID="GrdStudent" runat="server" AutoGenerateColumns="False" CellPadding="4" EnableSortingAndPagingCallbacks="false"
                                            DataKeyNames="StudentId,StudentName,Mobile" Width="100%" BorderColor="#3366CC" BorderStyle="None"
                                            AllowPaging="false" BackColor="White" BorderWidth="1px" PageSize="4" OnPageIndexChanging="GrdStudent_PageIndexChanging">
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="StudentId" DataField="StudentId" ItemStyle-HorizontalAlign="Center">
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:BoundField>
                                ...
                                <tr>
                                    <td colspan="4">
                                        ...
                                        <asp:GridView ID="GrdParent" runat="server" AutoGenerateColumns="False" 
                                            CellPadding="4" DataKeyNames="UserCode,FullName,FatherName,ParentMobile"
                    ...
                    <asp:Panel ID="Panel_Employee" runat="server" Visible="false" Style="height:500px; width:80%" class="well well-large">
                        <table style="width:100%;">
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:DropDownList ID="ddlDepartment" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlDepartment_SelectedIndexChanged" Width="180px"> 
                                    </asp:DropDownList>
                                </td>
                                <td  align="left">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <asp:DropDownList ID="ddlDesignation" runat="server" AutoPostBack="true" Style="margin-top: 5px;"
                                                OnSelectedIndexChanged="ddlDesignation_SelectedIndexChanged" Width="180px">
                                            </asp:DropDownList>
                                        </td>
                                        <td align="left">
                    ...
                    <asp:Panel ID="Panel_Message" runat="server" Visible="true" Style="height: auto; width:80%" class="well well-large">
                        <table border="0" width="100%" align="center" cellspacing="2px">
                            <tr>
                                <td colspan="4">
                                    <br />
                            ...
                            <tr>
                                <td colspan="4" align="center">
                                    ...
                                    <asp:TextBox ID="txtMessage" runat="server" TextMode="MultiLine" style = "resize:none" Height="100px" MaxLength="160" Width="65%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>

<asp:TextBox ID="abc" runat="server" Visible="false" ></asp:TextBox>
                                <td colspan="4" align="center">
