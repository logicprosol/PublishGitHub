...
{
    public partial class FacultyViewProfile : System.Web.UI.Page
    {
        //Faculty View
        #region[Faculty View]
        ...
        private void ShowFacultyProfile(EWA_Faculty objEWA)
        {
            ...
            try
            {
                ...
                lblBirthDate.Text = Convert.ToDateTime( ds.Tables[0].Rows[0]["DOB"]).ToString("dd/MM/yyyy");
                ...
                lblDateOfJoining.Text = Convert.ToDateTime(ds.Tables[0].Rows[0]["DateOfJoining"] ).ToString("dd/MM/yyyy");
