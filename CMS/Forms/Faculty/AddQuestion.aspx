<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Faculty/Faculty.Master" AutoEventWireup="true" CodeBehind="AddQuestion.aspx.cs" Inherits="CMS.Forms.Faculty.AddQuestion" %>
                        ...
                        <tr>
                            <th colspan="2" style="background-color: #0C7BFA; color: White">
                                <ul class="nav nav-list">
                                    <li><i class="icon-book"></i>Add Questions</li>
                                </ul>
                            </th>
                        </tr>
                    </table>
...
AND ([SubjectId] = @SubjectId)
                                        ...
                                        <asp:Button ID="Button1" runat="server" CausesValidation="False" CssClass="btn-primary" OnClick="Button1_Click" Text="Add Test Questions" />
                                        <table class="auto-style2" style="border: 2px solid #C0C0C0">
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="auto-style19">&nbsp;</td>
                                                <td class="auto-style13">
                                                    <asp:Label ID="lblLastName0" runat="server" CssClass="formlable" Font-Bold="True" Text="IsImageQuestion"></asp:Label>
                                                </td>
                                                <td class="auto-style12" valign="top">
                                                    <asp:CheckBox ID="chkImageQuestion" runat="server" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style19">&nbsp;</td>
                                                <td class="auto-style13">&nbsp;</td>
                                                <td class="auto-style12" valign="top" align="left">
                                            ...
                                            <tr>
                                                <td class="auto-style19">&nbsp;</td>
                                                <td class="auto-style13">
                                                    <asp:Label ID="lblLastName1" runat="server" CssClass="formlable" Font-Bold="True" Text="Upload Image as question: "></asp:Label>
                                                </td>
                                                <td class="auto-style12" valign="top">
                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">

                                                        <ContentTemplate>
                                                            <asp:FileUpload ID="ImgUpload" runat="server" Width="400px" />
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                    <br />
                                            ...
                                            <tr>
                                                <td class="auto-style19">&nbsp;</td>
                                                <td class="auto-style13">
                                                    <asp:Label ID="lblLastName" runat="server" CssClass="formlable" Font-Bold="True" Text="Add Question : "></asp:Label>
                                                </td>
                                                <td class="auto-style12" valign="top">
                                                    <asp:TextBox ID="txtQuestion" runat="server" Columns="4" CssClass="auto-style3" Enabled="false" Rows="4" TextMode="MultiLine" Width="400px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style19">&nbsp;</td>
                                                <td class="auto-style13">
                                                    <asp:Label ID="lblMotherName" runat="server" CssClass="formlable" Font-Bold="True" Text="Option A : "></asp:Label>
                                                    <asp:Label ID="lblMiddleName6" runat="server" CssClass="formlable" Font-Bold="True" ForeColor="#FF3300" Text="*"></asp:Label>
                                                </td>
                                                <td class="auto-style12">
                                                    <asp:TextBox ID="txtA" runat="server" Columns="2" CssClass="auto-style3" Enabled="false" Rows="2" TextMode="SingleLine" Width="400px"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="rfvMotherName" runat="server" ControlToValidate="txtA" ErrorMessage="Please Enter Answer !!!" ForeColor="red" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style19">&nbsp;</td>
                                                <td class="auto-style13">
                                                    <asp:Label ID="Label1" runat="server" CssClass="formlable" Font-Bold="True" Text="Option B : "></asp:Label>
                                                    <asp:Label ID="lblMiddleName7" runat="server" CssClass="formlable" Font-Bold="True" ForeColor="#FF3300" Text="*"></asp:Label>
                                                </td>
                                                <td class="auto-style12">
                                                    <asp:TextBox ID="txtB" runat="server" Columns="2" Enabled="false" Rows="2" TextMode="SingleLine" Width="400px"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtB" ErrorMessage="Please Enter Answer !!!" ForeColor="red" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style19">&nbsp;</td>
                                                <td class="auto-style13">
                                                    <asp:Label ID="Label2" runat="server" CssClass="formlable" Font-Bold="True" Text="Option C : "></asp:Label>
                                                    <asp:Label ID="lblMiddleName8" runat="server" CssClass="formlable" Font-Bold="True" ForeColor="#FF3300" Text="*"></asp:Label>
                                                </td>
                                                <td class="auto-style12">
                                                    <asp:TextBox ID="txtC" runat="server" Columns="2" Enabled="false" Rows="2" TextMode="SingleLine" Width="400px"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtC" ErrorMessage="Please Enter Answer !!!" ForeColor="red" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style19">&nbsp;</td>
                                                <td class="auto-style13">
                                                    <asp:Label ID="Label3" runat="server" CssClass="formlable" Font-Bold="True" Text="Option D : "></asp:Label>
                                                    <asp:Label ID="lblMiddleName9" runat="server" CssClass="formlable" Font-Bold="True" ForeColor="#FF3300" Text="*"></asp:Label>
                                                </td>
                                                <td class="auto-style12">
                                                    <asp:TextBox ID="txtD" runat="server" Columns="2" Enabled="false" Rows="2" TextMode="SingleLine" Width="400px"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtD" ErrorMessage="Please Enter Answer !!!" ForeColor="red" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style19">&nbsp;</td>
                                                <td class="auto-style13">
                                                    <asp:Label ID="Label4" runat="server" CssClass="formlable" Font-Bold="True" Text="Answer : "></asp:Label>
                                                    <asp:Label ID="lblMiddleName10" runat="server" CssClass="formlable" Font-Bold="True" ForeColor="#FF3300" Text="*"></asp:Label>
                                                </td>
                                                <td class="auto-style12">
                                                    <asp:DropDownList ID="txtAnswe" runat="server" Enabled="false" Height="29px" Width="400px">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtAnswe" ErrorMessage="Please Enter Answer !!!" ForeColor="red" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style19">&nbsp;</td>
                                                ...
                                                <td class="auto-style12" align="left">
                                                    ...
                                                    <asp:Button ID="btnSave" runat="server" CssClass="btn-primary" OnClick="btnSave_Click" Text="Save" ValidationGroup="Save" />

                                                    <%--<asp:Button ID="btnupdate" runat="server" CssClass="btn-primary" OnClick="btnupdate_Click" Text="Update" CausesValidation="False" />
                                            <asp:Button ID="btndelete" runat="server" CssClass="btn-primary" OnClick="btndelete_Click" Text="Delete" />--%>
                                                    <asp:Button ID="btnCancel" runat="server" CssClass="btn-primary" OnClick="btnCancel_Click1" Text="Cancel" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style19">&nbsp;</td>
                                                <td class="auto-style13">&nbsp;</td>
                                                <td class="auto-style12">
                                                    <%--<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnection %>" SelectCommand="SELECT [queId], [pattern], [unitType], [answer], [question], [SubjectName], [OrgId] FROM [tblAddQuestion] WHERE ([OrgId] = @OrgId)">
                                                <SelectParameters>
                                                    <asp:SessionParameter DefaultValue="0" Name="OrgId" SessionField="OrgId" Type="Decimal" />
                                                </SelectParameters>
                                            </asp:SqlDataSource>--%>
                                                </td>
                                            </tr>
                                       ...
                                       <%-- <asp:GridView ID="GridView1" runat="server" CellPadding="4" AllowPaging="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Option A" SortExpression="optA">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("optA") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Option B" SortExpression="optB">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label3" runat="server" Text='<%# Eval("optB") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Option C" SortExpression="optC">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("optC") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Option D" SortExpression="optD">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label5" runat="server" Text='<%# Eval("optD") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
