...
namespace CMS.Forms.Student
{
    public partial class StudentUpdateProfile : System.Web.UI.Page
    {
         ...
         private void LoadStateDropDown(string cid)
        {
         ...
         //    try
         //    {
         //        if (ddlParentCountry.SelectedValue.Equals("Select") && ddlParentCountry.SelectedValue.Equals(""))
         //        {
         //            msgBox.ShowMessage("Please Select Country First !!!", "Information", UserControls.MessageBox.MessageStyle.Critical);
         //        }
         //        else
         //        {
         //            LoadCityDropDown(ddlParentState.SelectedValue);
         //        }
         //    }
         //    catch (Exception exp)
         //    {
