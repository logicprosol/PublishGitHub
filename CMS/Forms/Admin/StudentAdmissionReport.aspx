<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="StudentAdmissionReport.aspx.cs" Inherits="CMS.Forms.Admin.StudentAdmissionReport" %>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel_SetCourseClass" runat="server" align="center" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div style="width: 100%; height: auto; margin-left: auto; margin-right: auto;">
                                        <table border="0" width="90%" align="center" cellspacing="2px">
                                            ...
                                            <tr>
                                                <td></td>
                                                <td>
                                                    <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red" ErrorMessage="Please Select Fees Category !!!"
                                                        ControlToValidate="ddlClass" ValidationGroup="grpSave" InitialValue="0"></asp:RequiredFieldValidator>--%>
                                                </td>
                                                <td>&nbsp;</td>
                                                <td>
                                    ...
                                    <div style="max-height: 640px; overflow: auto;">
                                                    ...
                                                    <br /><center>
                                                        <asp:Button ID="btnExport" runat="server" Text="Export" Visible="False" Style="height: 28px ;width:80px" OnClick="btnExport_Click" />
                                                        </center><br />
                                </ContentTemplate>
                            </asp:UpdatePanel>
