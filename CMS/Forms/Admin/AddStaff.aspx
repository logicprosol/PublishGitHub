<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddStaff.aspx.cs" Inherits="CMS.Forms.Admin.AddStaff" %>
                    ...
                    <table border="0" width="730px" align="center">
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td class="auto-style101">
                                ...
                                <asp:RequiredFieldValidator ID="rfvPresentCountry2" runat="server" ControlToValidate="ddlBloodGroup" ErrorMessage="Please Select BloodGroup !!!" ForeColor="red" ValidationGroup="General" InitialValue="0">*</asp:RequiredFieldValidator>
                            </td>
                        ...
                        <tr>
                            <td class="auto-style100">
                                ...
                                <asp:RequiredFieldValidator ID="rfvPresentCountry" runat="server" ControlToValidate="ddlPresentCountry" ErrorMessage="Please Select Country !!!" ForeColor="red" ValidationGroup="General" InitialValue="0">*</asp:RequiredFieldValidator>
                            </td>
                            <td class="auto-style100">
                                <asp:Label ID="lblPresentCountry0" runat="server" CssClass="formlable" Text="State : " Font-Bold="True"></asp:Label>
                                <asp:RequiredFieldValidator ID="rfvPresentState" runat="server" ControlToValidate="ddlPresentState" ErrorMessage="Please Select State !!!" ForeColor="red" ValidationGroup="General">*</asp:RequiredFieldValidator>
                                <asp:RequiredFieldValidator ID="rfvPresentCountry0" runat="server" ControlToValidate="ddlPresentState" ErrorMessage="Please Select State !!!" ForeColor="red" ValidationGroup="General" InitialValue="0">*</asp:RequiredFieldValidator>
                            </td>
                            <td class="auto-style107">
                                &nbsp;</td>
                            <td width="230px">
                                <asp:Label ID="lblPresentCountry1" runat="server" CssClass="formlable" Text="District : " Font-Bold="True"></asp:Label>
                                <asp:RequiredFieldValidator ID="rfvPresentCity" runat="server" ControlToValidate="ddlPresentCity" ErrorMessage="Please Select City !!!" ForeColor="red" ValidationGroup="General">*</asp:RequiredFieldValidator>
                                <asp:RequiredFieldValidator ID="rfvPresentCountry1" runat="server" ControlToValidate="ddlPresentCity" ErrorMessage="Please Select City !!!" ForeColor="red" ValidationGroup="General" InitialValue="0">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style100">
                        ...
                        <tr>
                            <td class="auto-style100">
                                ...
                                <asp:RequiredFieldValidator ID="rfvCasteCategory0" runat="server" ControlToValidate="DDL_Role" ErrorMessage="Please select Role !!!" ForeColor="Red" InitialValue="Select" ValidationGroup="General">*</asp:RequiredFieldValidator>
                            </td>
                            <td class="auto-style100">
                            ...
                            <tr>
                                ...
                                <td class="auto-style100">
                                    <asp:RadioButtonList ID="rbtnDesignationType" runat="server" AutoPostBack="True" CssClass="radio" RepeatDirection="Horizontal" ValidationGroup="General" Width="190px" OnSelectedIndexChanged="rbtnDesignationType_SelectedIndexChanged">
                                    </asp:RadioButtonList>
                                </td>
                                <td class="auto-style107">&nbsp;</td>
                                <td class="auto-style1" width="230px">
                            ...
                            <tr>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlDepartment" ErrorMessage="Please Select Department !!!" ForeColor="red" ValidationGroup="General" InitialValue="0">*</asp:RequiredFieldValidator>
                                </td>
                                <td class="auto-style100">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlDesignation" ErrorMessage="Please Select Designation !!!" ForeColor="red" ValidationGroup="General" InitialValue="0">*</asp:RequiredFieldValidator>
                                </td>
                                <td class="auto-style107">
                                    &nbsp;</td>
                                <td class="auto-style1" width="230px">
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td class="auto-style100">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvPhotoUpload" runat="server" ControlToValidate="txtimg" ErrorMessage="Please Upload Photo !!!" ForeColor="red" ValidationGroup="General" InitialValue="0">*</asp:RequiredFieldValidator>
                                    </td>
                                    <td class="auto-style100">
                                        &nbsp;</td>
                                    <td class="auto-style107">&nbsp;</td>
                                    <td class="auto-style1" width="230px">
                                        <asp:Label ID="lblPassword0" runat="server" Font-Bold="True" Text="Password : "></asp:Label>
                                        <asp:Label ID="Label74" runat="server" ForeColor="#FF3300" Text="*"></asp:Label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtPassword" CssClass="ValidationError" ErrorMessage="« (Required)" ToolTip="Compare Password is a REQUIRED field">*</asp:RequiredFieldValidator>
                                        <asp:RequiredFieldValidator ID="rfdPassword0" runat="server" ControlToValidate="txtPassword" ErrorMessage="Please Enter Password !!!" ForeColor="red" ValidationGroup="General">*</asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style100">
                                    ...
                                    <td class="auto-style100">
                                        <asp:Image ID="img_FacultyImage" runat="server" Height="100px" ImageUrl="~/images/userphoto.gif" Width="100px" />
                                        <asp:TextBox ID="txtimg" runat="server" Text="0"  Visible="false" ValidationGroup="General"></asp:TextBox>
                                    </td>
                                    <td class="auto-style107">&nbsp;</td>
                                    <td class="auto-style1" width="230px">
