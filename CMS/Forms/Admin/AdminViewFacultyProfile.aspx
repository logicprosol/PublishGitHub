<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AdminViewFacultyProfile.aspx.cs" Inherits="CMS.Forms.Admin.AdminViewFacultyProfile" %>
...
<%--                                            <asp:TextBox ID="txtPresentCity" runat="server"></asp:TextBox>--%>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            ...
                                            <br />
                                            <asp:RequiredFieldValidator ID="rfvCastCategory" runat="server" ControlToValidate="ddlCastCategory" ErrorMessage="Please Select Cast Category !!!" ForeColor="red" ValidationGroup="StaffInfo" InitialValue="0"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                </table>
                            </asp:Panel>
