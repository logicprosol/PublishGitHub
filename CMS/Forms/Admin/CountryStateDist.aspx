<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="CountryStateDist.aspx.cs" Inherits="CMS.Forms.Admin.ContryStateDist" %>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel_State" runat="server" align="center" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <table border="0" width="80%" align="center" cellspacing="2px">
                                        ...
                                        <tr>
                                            <td colspan="2" align="center">
                                                <asp:Button ID="btnNewS" runat="server" Text="Add New" class="btn btn-primary" OnClick="btnNewS_Click"
                            ...
                            <asp:UpdatePanel ID="UpdatePanel_District" runat="server" align="center" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <table border="0" width="80%" align="center" cellspacing="2px">
                                        ...
                                        <tr>
                                            <td colspan="2" align="center">
                                                <asp:Button ID="btnNewD" runat="server" Text="Add New" class="btn btn-primary" OnClick="btnNewD_Click"
