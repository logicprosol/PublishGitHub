<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Admin/College_Home.Master" AutoEventWireup="true"
    CodeBehind="AdmissionForm3.aspx.cs" Inherits="CMS.Forms.Admin.AdmissionForm3" %>
                            ...
                            <div class="MainBody">
                                <div class="frmwidth" align="center">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#sp1" data-toggle="tab" >
                                    ...
                                    <div class="tab-content">
                                        ...
                                        placeholder="Select College" OnSelectedIndexChanged="DDL_SelectCollege_SelectedIndexChanged" AutoPostBack="True">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="auto-style10">
                                                                            <asp:TextBox ID="txtGRNo" runat="server" placeholder="GR Number" ValidationGroup="vg"></asp:TextBox>
                                                                        ...
                                                                        <td class="auto-style9">
                                                                            <asp:TextBox ID="txtAdhar" runat="server" onkeypress="return isNumberKey(event)" placeholder="Adhar No" ValidationGroup="vg"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="input-medium">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="5">
                                                                            <asp:TextBox ID="txtFirstName" onkeypress="return isCharacterKey(event)" runat="server" placeholder="First Name" ValidationGroup="vg" Width="230px"></asp:TextBox>
                                                                            ...
                                                                            <asp:TextBox ID="txtMiddleName" runat="server" onkeypress="return isCharacterKey(event)" placeholder="Middle Name" ValidationGroup="vg" Width="230px"></asp:TextBox>
                                                                            ...
                                                                            <asp:TextBox ID="txtLastName" runat="server" onkeypress="return isCharacterKey(event)" placeholder="Last Name" ValidationGroup="vg" Width="230px"></asp:TextBox>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="auto-style9">
                                                                            <asp:TextBox ID="txtTal" onkeypress="return isCharacterKey(event)" runat="server" placeholder="Taluka" ValidationGroup="vg" Width="156px"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="input-medium">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="auto-style9">
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="rfvCast0" runat="server" ControlToValidate="ddlFeeCategory" ErrorMessage="Please Select Fee Category!" ForeColor="Red" InitialValue="Select" ValidationGroup="vg">*</asp:RequiredFieldValidator>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="auto-style10">
                                                                            <asp:TextBox ID="txtFather" onkeypress="return isCharacterKey(event)" runat="server" placeholder="Father Name" ValidationGroup="vg" Width="160px"></asp:TextBox>
                                                                        ...
                                                                        <td class="auto-style10">
                                                                            <asp:TextBox ID="txtMother" onkeypress="return isCharacterKey(event)" runat="server" placeholder="Mother Name" ValidationGroup="vg" Width="160px"></asp:TextBox>
                                                                        </td>
                                                                        <td align="center" class="input-medium">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="auto-style10" style="color:red">Upload image only with minimum size of 5KB or maximum size of 1MB </td>
                                                                        <td class="input-medium">&nbsp; </td>
