<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs"
    Inherits="CMS.Common.ChangePassword" %>
            ...
            <div class="MainBody">
                <table border="0" width="80%" align="center" cellspacing="2px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtOldPassword" runat="server" ValidationGroup="ValidatePassword"></asp:TextBox>
                            <br />
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNewPassword" runat="server" ValidationGroup="ValidatePassword"></asp:TextBox>
                            <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtConfirmPassword" runat="server" ValidationGroup="ValidatePassword"></asp:TextBox>
                        </td>
                        <td>
                            <asp:RequiredFieldValidator ID="rfvConfirmPassword" runat="server" ControlToValidate="txtConfirmPassword"
                                ErrorMessage="Confirm Pasword And New Password Mismatch." ValidationGroup="ValidatePassword"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center">
                            <asp:Button ID="btnChange" runat="server" Text="Change Password" class="btn btn-primary"
                                ValidationGroup="ValidatePassword" CausesValidation="true"
